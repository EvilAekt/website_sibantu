...
@section('content')
    <!-- Hero Section -->
    <div
        class="bg-gradient-to-br from-blue-600 via-blue-700 to-indigo-700 py-16 text-white text-center relative overflow-hidden">
    ...
    <div id="campaigns" class="container mx-auto px-4 py-12">
            ...
            <form method="GET" action="{{ route('campaigns.index') }}"
                ...
                <div class="flex flex-wrap gap-4">
                    <select name="category"
                        class="rounded-xl border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-white focus:ring-blue-500 focus:border-blue-500 py-2.5 px-4">
                        ...
                        <option value="pendidikan" {{ request('category') == 'pendidikan' ? 'selected' : '' }}>Pendidikan
                        </option>
                    ...
                    <select name="sort"
                        ...
                        <option value="target_asc" {{ request('sort') == 'target_asc' ? 'selected' : '' }}>Target Terkecil
                        </option>
                        <option value="target_desc" {{ request('sort') == 'target_desc' ? 'selected' : '' }}>Target Terbesar
                        </option>
                    </select>
                    ...
                    @if(request()->hasAny(['search', 'category', 'sort']))
                        <a href="{{ route('campaigns.index') }}"
                            class="bg-gray-100 dark:bg-gray-700 text-gray-700 dark:text-gray-300 hover:bg-gray-200 dark:hover:bg-gray-600 px-6 py-2.5 rounded-xl font-medium transition flex items-center justify-center gap-2">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            @foreach($campaigns as $campaign)
                <div
                    class="group bg-white dark:bg-gray-800 rounded-2xl shadow-lg overflow-hidden hover:shadow-xl transition duration-300 border border-gray-100 dark:border-gray-700 flex flex-col h-full">
                    <!-- Image -->
                    <div class="h-48 bg-gray-200 dark:bg-gray-700 relative overflow-hidden flex-shrink-0">
                        ...
                        <div class="absolute top-3 right-3">
                            <span
                                class="inline-flex items-center px-3 py-1 rounded-full text-xs font-semibold {{ $daysLeft <= 7 ? 'bg-red-500' : 'bg-gray-900/80' }} text-white backdrop-blur-sm shadow-sm">
                    ...
                    <div class="p-6 flex flex-col flex-1">
                        ...
                        <div class="flex items-center gap-2 mb-3">
                            <div
                                class="w-6 h-6 rounded-full bg-blue-100 flex items-center justify-center text-xs text-blue-600 font-bold">
